...
class PayPeriodWorksheet extends Component {
	...
	dropMenus() {
		const dropMenusData = [
			...
			['http://127.0.0.1:5000/Api/Stores', 'Select a Store', 'store_id', this.showStylists(this.value, true), 'store_id', 'store_name'],
			['http://127.0.0.1:5000/Api/Employees', 'Select an Employee', 'stylist_id', this.showPayPeriods(this.value, true), 'stylist_id', 'stylist_name'],
